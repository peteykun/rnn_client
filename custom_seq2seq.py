...
def embedding_attention_bidirectional_seq2seq(encoder_inputs, decoder_inputs, input_cell1, input_cell2, output_cell, num_encoder_symbols,
    ...
    with tf.variable_scope(scope or "embedding_attention_bidirectional_seq2seq", dtype=dtype) as scope:
        dtype = scope.dtype
        ...
        encoder_outputs, encoder_state1, encoder_state2 = tf.nn.bidirectional_rnn(encoder_cell1, encoder_cell2, encoder_inputs, dtype=dtype)
